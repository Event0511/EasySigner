...
public class MonitorUI implements View.OnClickListener {
    ...
    public MonitorUI(MonitorActivity monitorActivity , StreamLiveCameraView liveCameraView , String rtmpUrl) {
...
//               isMirror = !isMirror;
//               break;
           case R.id.btn_getResult://获取查询结果
